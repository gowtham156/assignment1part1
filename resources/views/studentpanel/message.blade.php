    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">Message From Admin</div>

                <div class="panel-body">
   


  @if(Session::has('acsuccess'))
<div class="alert alert-success">
   {{ Session::get('acsuccess') }}
</div>
@endif


  @if(Session::has('acerror'))
...
<table class="table">
    <tr>
       @if(count($post)>0)
            @foreach($post as $p)
         <td>Student Number</td>  <td>  {{$p->student_number}}</td></tr><tr>
         <td>Date Approved</td>  <td>  {{$p->today}}</td></tr><tr>
         <td>Status</td>  <td>  {{$p->status}}</td></tr>
            <tr><td>Action</td><td><a href="{{url('accept/'.$p->id.'/'.$p->today."/")}}" class='btn btn-xs btn-info pull-right'>Accept</a></td></tr>  
              
             @endforeach
    @else
    <td>No New Offers</td></tr>
    @endif
</table>
