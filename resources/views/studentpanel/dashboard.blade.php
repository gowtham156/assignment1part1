...
@endif
    ...
    <form method="POST" action="public/slogin" accept-charset="UTF-8" enctype="multipart/form-data" autocomplete="off" onpaste="return false" >
       ...
       <h5><b>Student Name : </b>    <?php echo $sid->student_fname; ?>&nbsp;   <?php echo $sid->student_lname; ?>
     &nbsp; <?php echo $sid->student_sname; ?></h5>
      </h5>
        <h5><b>Gender : </b>    <?php echo $sid->gender; ?></h5>
        <h5><b>Country : </b>    <?php echo $sid->ethnicity; ?></h5>
        <h5><b>Date of Birth : </b>    <?php echo $sid->dob; ?></h5>
        <h5><b>Email Address: </b>    <?php echo $sid->email; ?></h5>
