    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">Propose</div>
...
@endif
                   ...
                   <form method="POST" action="public/proposalr" accept-charset="UTF-8" enctype="multipart/form-data" autocomplete="off">
       {{ csrf_field() }}		<!—To protect your application from CSRF attacks-->
       
              <h5> Proposal </h5>
    
           <div class="form-group">
           <textarea name="proposal" class="form-control title" placeholder="Your Proposal" rows=60></textarea>
       </div>
             @if($errors->has('proposal')) 
         <div class='alert alert-danger'>{{$errors->first('proposal')}}</div>
   ...
   @endif
           ...
           <div class="form-group">
             &nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" name="submit" class="btn btn-warning" value="Propose"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="reset" name="clear" class="btn btn-primary" value="Clear">
           </div>
       </div>
    </form>
